...
class ControlComponentType(Submodel):
    class Interfaces(SubmodelElementCollectionUnordered):
        class Interface(ReferenceElement):
            def __init__(
                self,
                value: Reference,
                id_short: str = "Interface",
                ...
                semantic_id: Optional[Reference] = Reference(
                    key=(
                        Key(
                            ...
                            local=True,
                            value="https://admin-shell.io/idta/ControlComponent/Type/Interface/1/0",
                            id_type=KeyType.IRI,
                        ),
                    )
                ),
                ...
                if description is None:
                    description = {"en": "Reference to a single control interface. "}
        ...
        def __init__(
            ...
            semantic_id: Optional[Reference] = Reference(
                key=(
                    Key(
                        type_=KeyElements.CONCEPT_DESCRIPTION,
                        local=True,
                        value="https://admin-shell.io/idta/ControlComponent/Type/Interfaces/1/0",
                        id_type=KeyType.IRI,
                    ),
                )
            ),
            ...
            if description is None:
                description = {
                    "en": "Collection of references to control interfaces supported by the component type, e.g. to elements of the Interface Metadata SMC of the Asset Interface Description submodel, the MTP submodel or OPC UA Server Datasheet submodel."
                }
    ...
    class Errors(SubmodelElementCollectionUnordered):
        class ErrorCode(MultiLanguageProperty):
            def __init__(
                ...
                semantic_id: Optional[Reference] = Reference(
                    key=(
                        Key(
                            type_=KeyElements.CONCEPT_DESCRIPTION,
                            local=True,
                            value="https://admin-shell.io/idta/ControlComponent/Type/ErrorCode/1/0",
                            id_type=KeyType.IRI,
                        ),
                    )
                ),
                ...
                if description is None:
                    description = {
                        "en": "Semantic description of the error code in multiple languages"
                    }
        ...
        def __init__(
            ...
            semantic_id: Optional[Reference] = Reference(
                key=(
                    Key(
                        type_=KeyElements.CONCEPT_DESCRIPTION,
                        local=True,
                        value="https://admin-shell.io/idta/ControlComponent/Type/Errors/1/0",
                        id_type=KeyType.IRI,
                    ),
                )
            ),
            ...
            if description is None:
                description = {
                    "en": "Collection of all possible error codes that may appear in components of this type."
                }
    ...
    def __init__(
        ...
        skills: Skills,
        errors: Errors,
        id_short: str = "ControlComponentType",
        category: Optional[str] = None,
        description: Optional[LangStringSet] = None,
        ...
        semantic_id: Optional[Reference] = Reference(
            key=(
                Key(
                    type_=KeyElements.CONCEPT_DESCRIPTION,
                    local=False,
                    value="https://admin-shell.io/idta/ControlComponent/Type/1/0",
                    id_type=KeyType.IRI,
                ),
            )
        ),
