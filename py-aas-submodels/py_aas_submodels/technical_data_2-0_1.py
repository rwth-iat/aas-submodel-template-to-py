    ...
    class ProductClassifications(SubmodelElementList):
        ...
        class Productclassifications_item(SubmodelElementCollection):
            ...
            def __init__(
                ...
                # Add all passed/initialized submodel elements to a single list
                embedded_submodel_elements = []
                for se_arg in [classificationSystemVersion,classificationSystemUrl,productClassId,productClassCodedName,productClassName,referenceToTechnicalPropertyArea]:
                    if se_arg is None:
                        continue
                    elif isinstance(se_arg, SubmodelElement):
                        embedded_submodel_elements.append(se_arg)
