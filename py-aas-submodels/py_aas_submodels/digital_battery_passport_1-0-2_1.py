    ...
    class TechnicalPropertyAreas(SubmodelElementCollection):
        ...
        class PowerCapability(SubmodelElementCollection):
            ...
            class RatioNominalBatteryPowerAndBatteryEnergy(Property):
                ...
                def __init__(
                        self,
                                    ...
                                    id_short: Optional[str]=r'RatioNominalBatteryPowerAndBatteryEnergy',
            ...
            def __init__(
                    ...
                    ratioNominalBatteryPowerAndBatteryEnergy: Optional[Union[Float, RatioNominalBatteryPowerAndBatteryEnergy]] = None,
                ...
                # Build a submodel element if a raw value was passed in the argument
                if ratioNominalBatteryPowerAndBatteryEnergy and not isinstance(ratioNominalBatteryPowerAndBatteryEnergy, SubmodelElement):
                    ratioNominalBatteryPowerAndBatteryEnergy=self. RatioNominalBatteryPowerAndBatteryEnergy(ratioNominalBatteryPowerAndBatteryEnergy)
                ...
                # Add all passed/initialized submodel elements to a single list
                embedded_submodel_elements = []
                for se_arg in [maximumPermittedBatteryPower,powerFade,ratioNominalBatteryPowerAndBatteryEnergy,originalPowerCapability]:
                    if se_arg is None:
                        continue
                    elif isinstance(se_arg, SubmodelElement):
                        embedded_submodel_elements.append(se_arg)
