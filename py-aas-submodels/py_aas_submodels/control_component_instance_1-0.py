            ...
            semantic_id: Optional[Reference] = ExternalReference(
                key=(
                    Key(
                        ...
                        value=r"https://admin-shell.io/idta/ControlComponent/Instance/Type/1/0",
                    ),
                ),
    ...
    class Endpoints(SubmodelElementCollection):
        ...
        class Endpoint(ReferenceElement):
            ...
            def __init__(
                ...
                category: Optional[str] = None,
                description: Optional[MultiLanguageTextType] = MultiLanguageTextType(
                    dict_={r"en": r"A reference to a control endpoint."}
                ),
                semantic_id: Optional[Reference] = ExternalReference(
                    key=(
                        Key(
                            type_=KeyTypes.GLOBAL_REFERENCE,
                            value=r"https://admin-shell.io/idta/ControlComponent/Instance/Endpoint/1/0",
                        ),
                    ),
                    referred_semantic_id=None,
                ),
        ...
        def __init__(
            ...
            semantic_id: Optional[Reference] = ExternalReference(
                key=(
                    Key(
                        type_=KeyTypes.GLOBAL_REFERENCE,
                        value=r"https://admin-shell.io/idta/ControlComponent/Instance/Endpoints/1/0",
                    ),
                ),
                referred_semantic_id=None,
            ),
        ...
        semantic_id: Optional[Reference] = ModelReference(
            key=(
                Key(
                    ...
                    value=r"https://admin-shell.io/idta/ControlComponent/Instance/1/0",
                ),
            ),
            type_=Submodel,
            referred_semantic_id=None,
