            ...
            class AdministrativeData(SubmodelElementCollection):
                                ...
                                def __init__(
                                    ...
                                    semantic_id: Optional[
                                        ...
                                        key=(
                                            Key(
                                                type_=KeyTypes.GLOBAL_REFERENCE,
                                                value=r"https://admin-shell.io/idta/DigitalQualityDocument/1/0/administrativeData/coreData/Identifications/refType",
                                            ),
                                        ),
                                        referred_semantic_id=None,
                                    ),
                ...
                class Statements(SubmodelElementList):
                    ...
                    class Statements_item(SubmodelElementCollection):
                        ...
                        class Conformity(Property):

                            def __init__(
                                self,
                                value: str,
                                id_short: Optional[str] = r"Conformity",
                                value_type: DataTypeDefXsd = str,
                                value_id: Optional[Reference] = None,
                                display_name: Optional[
                                    MultiLanguageNameType
                                ] = MultiLanguageNameType(dict_={r"en": r"Conformity"}),
                                category: Optional[str] = None,
                                description: Optional[
                                    MultiLanguageTextType
                                ] = MultiLanguageTextType(
                                ...
                                semantic_id: Optional[Reference] = ExternalReference(
                                    key=(
                                        Key(
                                            type_=KeyTypes.GLOBAL_REFERENCE,
                                            value=r"https://admin-shell.io/idta/DigitalQualityDocument/1/0/administrativeData/Statements/Conformity",
                                        ),
                                    ),
                                    referred_semantic_id=None,
                                ),
