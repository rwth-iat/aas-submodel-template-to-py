...
class RailwayFireProtection(Submodel):
        ...
        class RequirementsSets(SubmodelElementList):
                ...
                class HazardLevel(Property):
                    ...
                    def __init__(
                            ...
                            "Not Compliant"'}),
                                        ...
                                        semantic_id: Optional[Reference]=ExternalReference(key=(Key(type_=KeyTypes.GLOBAL_REFERENCE, value=r'https://admin-shell.io/RailwayFireProtection/Submodel/1/HazardLevel'),), referred_semantic_id=None),
            ...
            def __init__(
                    ...
                    requirementssets_items: Requirementssets_item,
                                ...
                                display_name: Optional[MultiLanguageNameType]=MultiLanguageNameType(dict_={r'en': r'Reqirements sets'}),
                ...
                class Tests(SubmodelElementList):
                    ...
                    class Tests_item(SubmodelElementCollection):
                        ...
                        def __init__(
                            ...
                            # Add all passed/initialized submodel elements to a single list
                            embedded_submodel_elements = []
                            for se_arg in [testProcedure,testResult,testDate,testReportNumber]:
                                if se_arg is None:
                                    continue
                                elif isinstance(se_arg, SubmodelElement):
                                    embedded_submodel_elements.append(se_arg)
                ...
                class LabInformation(SubmodelElementCollection):
                    ...
                    class LabAddress(SubmodelElementCollection):
                        ...
                        class AddressOfAdditionalLink(Property):
                            ...
                            def __init__(
                                    self,
                                                ...
                                                semantic_id: Optional[Reference]=ExternalReference(key=(Key(type_=KeyTypes.GLOBAL_REFERENCE, value=r'0173-1#02-AAQ326#002'),), referred_semantic_id=None),
                                ...
                                if qualifier is None:
                                    qualifier = (Qualifier(type_=r'Multiplicity', value_type=str, value=r'ZeroToOne', value_id=None, kind=QualifierKind.CONCEPT_QUALIFIER, semantic_id=None, supplemental_semantic_id=()),)
                        ...
                        class NationalCode(MultiLanguageProperty):
                            ...
                            def __init__(
                                    self,
                                                ...
                                                description: Optional[MultiLanguageTextType]=MultiLanguageTextType(dict_={r'en': r' Note: country codes defined accord. to ISO 3166-1. Recommendation: property declaration as MLP is required by its semantic definition. As the property value is language independent, users are recommended to provide maximal 1 string in any language of the user’s choice.'}),
                                                
                                                semantic_id: Optional[Reference]=ExternalReference(key=(Key(type_=KeyTypes.GLOBAL_REFERENCE, value=r'0173-1#02-AAO134#002'),), referred_semantic_id=None),
                        ...
                        class CityTown(MultiLanguageProperty):
                            ...
                            def __init__(
                                    self,
                                                ...
                                                semantic_id: Optional[Reference]=ExternalReference(key=(Key(type_=KeyTypes.GLOBAL_REFERENCE, value=r'0173-1#02-AAO132#002'),), referred_semantic_id=None),
                        ...
                        class Company(MultiLanguageProperty):
                            ...
                            def __init__(
                                    self,
                                                ...
                                                semantic_id: Optional[Reference]=ExternalReference(key=(Key(type_=KeyTypes.GLOBAL_REFERENCE, value=r'0173-1#02-AAW001#001'),), referred_semantic_id=None),
                        ...
                        class Phone(SubmodelElementCollection):
                            ...
                            class TelephoneNumber(MultiLanguageProperty):
                                ...
                                def __init__(
                                        self,
                                                    ...
                                                    description: Optional[MultiLanguageTextType]=MultiLanguageTextType(dict_={r'en': r'Recommendation: property declaration as MLP is required by its semantic definition. As the property value is language independent, users are recommended to provide maximal 1 string in any language of the user’s choice.'}),
                                                    
                                                    semantic_id: Optional[Reference]=ExternalReference(key=(Key(type_=KeyTypes.GLOBAL_REFERENCE, value=r'0173-1#02-AAO136#002'),), referred_semantic_id=None),
                                    ...
                                    if qualifier is None:
                                        qualifier = (Qualifier(type_=r'Multiplicity', value_type=str, value=r'One', value_id=None, kind=QualifierKind.CONCEPT_QUALIFIER, semantic_id=None, supplemental_semantic_id=()),)
                            ...
                            def __init__(
                                    ...
                                    telephoneNumber: Union[LangStringSet, TelephoneNumber],
                                                ...
                                                semantic_id: Optional[Reference]=ExternalReference(key=(Key(type_=KeyTypes.GLOBAL_REFERENCE, value=r'https://admin-shell.io/zvei/nameplate/1/0/ContactInformations/ContactInformation/Phone'),), referred_semantic_id=None),
                        ...
                        class Email(SubmodelElementCollection):
                            ...
                            class EmailAddress(Property):
                                ...
                                def __init__(
                                        self,
                                                    ...
                                                    semantic_id: Optional[Reference]=ExternalReference(key=(Key(type_=KeyTypes.GLOBAL_REFERENCE, value=r'0173-1#02-AAO198#002'),), referred_semantic_id=None),
                            ...
                            def __init__(
                                    ...
                                    emailAddress: Union[str, EmailAddress],
                                                ...
                                                semantic_id: Optional[Reference]=ExternalReference(key=(Key(type_=KeyTypes.GLOBAL_REFERENCE, value=r'0173-1#02-AAQ836#005'),), referred_semantic_id=None),
                        ...
                        class Street(MultiLanguageProperty):
                            ...
                            def __init__(
                                    self,
                                                ...
                                                semantic_id: Optional[Reference]=ExternalReference(key=(Key(type_=KeyTypes.GLOBAL_REFERENCE, value=r'0173-1#02-AAO128#002'),), referred_semantic_id=None),
                        ...
                        class Zipcode(MultiLanguageProperty):
                            ...
                            def __init__(
                                    self,
                                                ...
                                                semantic_id: Optional[Reference]=ExternalReference(key=(Key(type_=KeyTypes.GLOBAL_REFERENCE, value=r'0173-1#02-AAO129#002'),), referred_semantic_id=None),
                        ...
                        def __init__(
                                ...
                                addressOfAdditionalLink: Optional[Union[str, AddressOfAdditionalLink]] = None,
                            ...
                            # Add all passed/initialized submodel elements to a single list
                            embedded_submodel_elements = []
                            for se_arg in [addressOfAdditionalLink,nationalCode,cityTown,company,phone,email,street,zipcode]:
                                if se_arg is None:
                                    continue
                                elif isinstance(se_arg, SubmodelElement):
                                    embedded_submodel_elements.append(se_arg)
    ...
    class Material(SubmodelElementCollection):
        ...
        class MaterialName(Property):
            ...
            def __init__(
                    self,
                                ...
                                display_name: Optional[MultiLanguageNameType]=MultiLanguageNameType(dict_={r'en': r'Material name'}),
        ...
        def __init__(
                ...
                testedMaterialCombinationDescription: Union[str, TestedMaterialCombinationDescription],
            ...
            # Add all passed/initialized submodel elements to a single list
            embedded_submodel_elements = []
            for se_arg in [materialName,materialCharacteristics,masses,testedMaterialCombinationDescription]:
                if se_arg is None:
                    continue
                elif isinstance(se_arg, SubmodelElement):
                    embedded_submodel_elements.append(se_arg)
