                ...
                def __init__(
                    ...
                    semantic_id: Optional[Reference] = ExternalReference(
                        key=(
                            Key(
                                type_=KeyTypes.GLOBAL_REFERENCE,
                                value=r"https://admin-shell.io/idta/WirelessCommunication/RadioFrequency/FrequencyBand/BandIDCurrent/1/0",
                            ),
                        ),
                        referred_semantic_id=None,
                    ),
            ...
            def __init__(
                ...
                semantic_id: Optional[Reference] = ExternalReference(
                    key=(
                        Key(
                            type_=KeyTypes.GLOBAL_REFERENCE,
                            value=r"https://admin-shell.io/idta/WirelessCommunication/ReceptionQualityIndicator/ParameterType/1/0",
                        ),
                    ),
                    referred_semantic_id=None,
                ),
            ...
            def __init__(
                ...
                semantic_id: Optional[Reference] = ExternalReference(
                    key=(
                        Key(
                            type_=KeyTypes.GLOBAL_REFERENCE,
                            value=r"https://admin-shell.io/idta/WirelessCommunication/License/Applicant/1/0",
                        ),
                    ),
                    referred_semantic_id=None,
                ),
